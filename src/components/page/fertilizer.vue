  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-hot"></i> 用肥指南</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
            ...
            <el-row :gutter="20">
              <el-col :lg='4'
                ...
                <el-card @click.native="handleClick(pest.id)">
                  <img src="@/assets/img/fertilizer.png"
                       class="image">
...
<script>
import { getData, findOne } from '@/api/fertilizer'
